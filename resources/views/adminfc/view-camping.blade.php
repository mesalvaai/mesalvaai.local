	...
	<div class="container pt-4 pb-4">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<a href="{{ route('publish.camping', $camping->id) }}" title="Alterar" class="btn btn-outline-success w-100 mb-3"><i class="fas fa-edit"></i> Publicar campanha</a>
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="progress bg-primary">
                            <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: {!! \ProgressBar::progressDonation($camping->funds_received, $camping->goal) !!}" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{!! \ProgressBar::progressDonation($camping->funds_received, $camping->goal) !!}
                            </div>
                        </div>
					...
					<div class="card-footer text-center">
						<a href="#" title="Alterar" class="btn btn-outline-warning">Lançar Campanha!</a>
					</div>
				</div>

				<div class="card mt-3">
					<div class="card-header bg-info">
						<h2 class="text-info text-center">RECOMPENSAS</h2>
					</div>
					<div class="card-body text-center">
						@foreach ($camping->rewards as $reward)
							<h3 class="text-success">$R {{ $reward->donation }}</h3>
