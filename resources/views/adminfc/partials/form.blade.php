...
<div class="row">
	<div class="form-group col-xs-12 col-md">
		{!! Form::label('name', 'Confira seu nome Completo') !!}
	...
	<div class="form-group col-xs-12 col-md">
		...
		{!! Form::text('data_of_birth', null , ['class' => 'form-control','placeholder' => '00/00/0000', 'required']) !!}
	</div>
...
<div class="row">
	...
	<div class="form-group col-xs-12 col-md">
		{!! Form::label('email', 'Confira seu E-mail') !!}
...
<div class="row">
	...
	<div class="form-group col-xs-12 col-md">
		...
		{!! Form::select('period_id', $periodo, null, ['class' => 'form-control','required']) !!}
	</div>
</div>
...
<div class="form-group text-center pt-5">
	{!! Form::submit('Continuar criando minha campanha', ['class' => 'btn btn-success btn-lg']) !!}
</div>