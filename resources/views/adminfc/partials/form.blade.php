...
<div class="row">
	<div class="form-group col-xs-12 col-md">
		{!! Form::label('status', 'Como conheceu a Me Salva Aí? *') !!}
		{!! Form::select('status', [''=> 'Selecione','google' => 'Google', 'facebook' => 'Facebook', 'e-mail' => 'E-mail', 'amigos' => 'Um amigo', 'outros' => 'Outros'], null, ['class' => 'form-control', 'required']) !!}
	</div>
	<div class="form-group col-xs-12 col-md">
