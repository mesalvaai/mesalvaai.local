...
<div class="container pt-5 pb-5">
	...
	@foreach ($campings as $camping)
		<div class="row pb-3">
			<div class="col-md">
				<div class="media">
					<img class="mr-3 w-50" src="{{ url('/miniatura/'. $camping->file) }}" alt="{{ $camping->title }}">
					<div class="media-body">
						...
						<a href="#" class="badge badge-success">Mais Info>></a>
					</div>
				</div>
			</div>
			<div class="col-md">
				<div class="card">
					<ul class="list-group list-group-flush">
						@foreach ($camping->rewards as $reward)
						    <li class="list-group-item">{{ $reward->title }}</li>
						@endforeach
						<li class="list-group-item">
							<a class="float-right btn btn-outline-success btn-sm" href="{{ route('create.rewards', $camping->id) }}" title="Nova Recompensa">Nova Recompensa</a>
							<a class="float-left btn btn-outline-info btn-sm" href="#" title="Nova Recompensa">Mais Info</a></li>
					</ul>
				</div>
			</div>
		</div>
